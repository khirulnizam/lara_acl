...
<html lang="en">
  ...
  <head>
    ...
    <title>#FSTMKUIS Training System</title>
    ...
    <!-- Font Awesome -->
    <link href="{{ asset('sbadmin/css/font-awesome.min.css') }}" rel="stylesheet">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.html">#FSTMKUIS</a>
    ...
    @else
      <!-- Only display this Navbar when user logged-in -->
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © FSTM KUIS 2018</span>
            </div>
          </div>
        </footer>
